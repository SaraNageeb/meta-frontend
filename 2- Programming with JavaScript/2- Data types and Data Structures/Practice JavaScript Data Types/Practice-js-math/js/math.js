...
let num1 = parseFloat(prompt('What is your favourite number'));
...
let num2 = parseFloat(prompt('What is your favourite number'));
...
let message = `<h1>Math  with the ${num1} and ${num2}</h1>`;
